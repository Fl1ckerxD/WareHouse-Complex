...
namespace Warehouse_Complex
{
    public partial class Directory : Form
    {
        ...
        private void Directory_Load(object sender, EventArgs e)
        {
            ...
            mySqlAplication.ShowTable("SELECT dbo.Расходы.Id, dbo.Расходы.Дата, dbo.Расходы.Товар_Id, dbo.Товары.Название [Название товара], dbo.Расходы.[Наименование получателя], " +
